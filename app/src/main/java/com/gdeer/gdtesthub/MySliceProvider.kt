...
import com.gdeer.gdtesthub.view.textview.FontActivity
...
class MySliceProvider : SliceProvider() {
    ...
    /**
     * Converts URL to content URI (i.e. content://com.gdeer.gdtesthub...)
     */
...
//        return null
        ...
        */
        ...
        return SliceAction.create(
                PendingIntent.getActivity(
                        context, 0, Intent(context, FontActivity::class.java), 0
                ),
                IconCompat.createWithResource(context, R.drawable.ic_launcher_foreground),
                ListBuilder.ICON_IMAGE,
                "Open App"
